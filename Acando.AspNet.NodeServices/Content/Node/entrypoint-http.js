...
/***/ function(module, exports, __webpack_require__) {
	...
	server.listen(requestedPortOrZero, 'localhost', function () {
	    ...
	    console.log('[Acando.AspNet.NodeServices.HttpNodeHost:Listening on port ' + server.address().port + '\]');
	    // Signal to the NodeServices base class that we're ready to accept invocations
	    console.log('[Acando.AspNet.NodeServices:Listening]');
	});
...
/***/ function(module, exports) {
	...
	// active .NET ILog. But by default, stdout/stderr don't have any way of distinguishing
	// linebreaks inside log messages from the linebreaks that delimit separate log messages,
	// so multiline strings will end up being written to the ILog as multiple independent
