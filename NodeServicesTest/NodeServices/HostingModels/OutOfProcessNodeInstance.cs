...
namespace Acando.AspNet.NodeServices.HostingModels
{
    using log4net;
    ...
    /// </summary>
    /// <seealso cref="Acando.AspNet.NodeServices.HostingModels.INodeInstance" />
    public abstract class OutOfProcessNodeInstance : INodeInstance
    {
        /// <summary>
        /// The <see cref="ILog"/> to which the Node.js instance's stdout/stderr is being redirected.
        /// </summary>
        protected readonly ILog OutputLogger;

        private const string ConnectionEstablishedMessage = "[Acando.AspNet.NodeServices:Listening]";
            ...
            IDictionary<string, string> environmentVars, bool launchWithDebugging, int debuggingPort)
        {
            ...
            //var startInfo = new ProcessStartInfo(@"C:\therealnode\node")
            {
        ...
        {
            OutputLogger.Info($"Node will restart because file changed: {fullPath}");
